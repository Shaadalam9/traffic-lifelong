...
CONFIG = PipelineContext(
    ...
    run_video_preparation=cfg("run_video_preparation", False),
    run_scene_config_export=cfg("run_scene_config_export", False),
    run_tracking=cfg("run_tracking", False),
    run_event_extraction=cfg("run_event_extraction", False),
    run_event_merge=cfg("run_event_merge", False),
